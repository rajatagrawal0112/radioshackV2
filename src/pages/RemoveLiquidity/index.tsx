...
import { ChainId, Currency, ETHER, Percent, WETH, currencyEquals } from 'quest-switchswap-sdk'
...
export default function RemoveLiquidity({
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Remove Liquidity`)} | RadioShack</title>
            </Helmet>
